...
fun ProfileScreen(
    ...
    val photoPickerLauncher =
        rememberLauncherForActivityResult(ActivityResultContracts.PickVisualMedia()) { uri ->
            uri?.let { viewModel.handleIntent(ProfileIntent.UpdatePhoto(uri)) }
        }
    ...
    ProfileScreenContent(
        ...
        onPaymentClick = { comingSoonFeature = "Payment" },
        onNotificationsClick = { comingSoonFeature = "Notifications" },
        onSecurityClick = onSecurityClick,
        onHelpClick = { comingSoonFeature = "Help" },
...
// ✅ FIX: Wrapped all items in a Column with spacedBy(spacing)
@Composable
