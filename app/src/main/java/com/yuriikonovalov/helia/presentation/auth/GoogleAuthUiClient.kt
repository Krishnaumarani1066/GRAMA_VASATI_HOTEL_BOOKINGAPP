...
class GoogleAuthUiClient(private val context: Context) {
    ...
    suspend fun getIntentSenderRequest(): IntentSenderRequest? {
        return try {
            ...
            val intentSender = result?.pendingIntent?.intentSender ?: return null
    ...
    fun getToken(intent: Intent): String? {  // ✅ returns nullable String
        return try {
    ...
    private fun buildSignInRequest(): BeginSignInRequest {
        return BeginSignInRequest.builder()
            ...
            .setAutoSelectEnabled(false) // ✅ FIXED: was true, caused silent skip
            .build()
    }
}